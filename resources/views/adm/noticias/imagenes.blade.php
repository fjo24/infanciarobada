...
@section('titulo', 'Listado de imagenes')
...
@section('contenido')
        ...
        <div class="row">
            <div class="row">
                {!!Form::open(['route'=>['imgnoticias.nueva', $noticia->id], 'method'=>'POST', 'files' => true])!!}
                <div class="row">
                ...
                <table class="highlight bordered">
                    ...
                    @foreach($imagenes as $imagen)
                        <tr>
                            ...
                            <td class="text-right">
                                   {!!Form::open(['class'=>'en-linea', 'route'=>['imgnoticias.destroy', $imagen->id], 'method' => 'DELETE'])!!}
