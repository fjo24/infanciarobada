...
@section('titulo', 'Listado de imagenes de ')
...
@section('contenido')
        ...
        <div class="row">
            <div class="row">
                {!!Form::open(['route'=>['imgeventos.nueva', $evento->id], 'method'=>'POST', 'files' => true])!!}
                <div class="row">
                ...
                <table class="highlight bordered">
                    ...
                    @foreach($imagenes as $imagen)
                        <tr>
                            ...
                            <td class="text-right">
                                   {!!Form::open(['class'=>'en-linea', 'route'=>['imgeventos.destroy', $imagen->id], 'method' => 'DELETE'])!!}
